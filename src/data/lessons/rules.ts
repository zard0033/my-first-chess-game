...
const specialRules: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      text: '最後是「逼和」。看這個盤面——黑王在角落，沒被將軍，卻一步都走不出去：a7 被后封、b8 被后封、b7 被王封。輪到黑方走，無路可走又沒被將軍，這局算「和棋」，不是你贏。',
      highlights: ['a8', 'a7', 'b8', 'b7'],
    },
    {
      fen: 'k7/8/1QK5/8/8/8/8/8 w - - 0 1',
      text: '換你來體驗這個陷阱。黑王又被逼到角落——但這次你要將死牠，不是逼和。試試「后走 b7」會發生什麼，再找真正的將死。',
      arrows: [{ orig: 'b6', dest: 'b8' }],
      expectedMove: { from: 'b6', to: 'b8' },
      hint: '后走 b7 看起來很近，但黑王沒被將軍、也動不了——那就和了。你要找的是「將軍 + 黑王完全無路可逃」。后在哪一格能同時控制整條第 8 列並給將軍？',
      successText: '后到 b8，將軍且黑王無路可逃——這是將死，不是逼和。大優時記得先問：我的走法會不會讓對方悄悄摸成和局？',
    },
  ],
}
...
const tier1Capstone: Lesson = {
  ...
  steps: [
    ...
    {
      fen: 'k7/8/8/8/8/8/1Q6/1K6 w - - 0 1',
      text: '換一個方向。黑王跑到左上角，你的后站在 b2。后能直走也能斜走——從 b2 找一步，將軍且黑王無路可逃。',
      highlights: ['a8'],
    },
    {
      fen: 'k7/8/8/8/8/8/1Q6/1K6 w - - 0 1',
      text: '沿著 b 行直走，能不能一步將死？',
      arrows: [{ orig: 'b2', dest: 'b8' }],
      expectedMove: { from: 'b2', to: 'b8' },
      hint: '后走 b8：沿 b 行給將軍，同時 b8 的斜線封 a7、b 行封 b7——黑王的三個鄰格全被蓋掉。',
      successText: '后到 b8，將軍且三格全封。后走直線、斜線都能將殺——換方向也一樣好用。',
    },
    {
      fen: '7k/5ppp/8/8/8/8/8/R6K w - - 0 1',
      text: '這次你只有城堡，沒有后。黑王同樣被三個兵關在角落——城堡能不能也一步將死？',
      highlights: ['h8', 'g7', 'h7'],
    },
    {
      fen: '7k/5ppp/8/8/8/8/8/R6K w - - 0 1',
      text: '城堡只走直線——沿哪一行或哪一列，能讓黑王逃無可逃？',
      arrows: [{ orig: 'a1', dest: 'a8' }],
      expectedMove: { from: 'a1', to: 'a8' },
      hint: '黑王在 h8，三個兵堵住 g7、h7、f7。城堡走到第 8 列給將軍，黑王能逃到 g8——g8 被城堡的橫線封住嗎？哪條直行能把整個第 8 列鎖死？',
      successText: '城堡到 a8，將軍並控制整條第 8 列——黑王無路可逃。不管是后還是城堡，原理都一樣：對方的王能去哪、你封得住嗎？',
    },
    {
      fen: 'R5k1/5ppp/8/8/8/8/8/6K1 b - - 0 1',
